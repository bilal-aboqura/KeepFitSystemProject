...
export function CatalogEntityManager({ kind, entities, lang }: { kind: "brands" | "categories"; entities: Entity[]; lang: "en" | "ar" }) {
  ...
  async function submit(event: React.FormEvent) {
    ...
    const data = kind === "brands" ? { ...form, description_en: "", description_ar: "", is_active: true } : { ...form, image: null, parent_id: null, is_active: true, sort_order: entities.length };
