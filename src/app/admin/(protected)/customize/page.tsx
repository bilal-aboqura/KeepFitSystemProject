...
const DEFAULT_HERO_SLIDES: HeroSlideDraft[] = [
  {
    ...
    title_en: "Fuel every goal.",
    title_ar: "كل هدف يبدأ من تغذية صح.",
    subtitle_en: "Supplements and training essentials in one place. Find what fits your goal and keep moving forward.",
    subtitle_ar: "مكملاتك وأساسياتك الرياضية في مكان واحد. اختار اللي يناسب هدفك وكمّل أقوى كل يوم.",
    cta_en: "Shop now",
    cta_ar: "تسوق دلوقتي",
    href: "#bestsellers",
  },
...
const DEFAULTS: Fields = {
  store_name: { value_en: "KeepFit Supplement", value_ar: "KeepFit Supplement" },
  store_tagline: { value_en: "Fuel Your Goal", value_ar: "طاقتك تبدأ هنا" },
  ...
  hero_title: { value_en: "Fuel every goal.", value_ar: "كل هدف يبدأ من تغذية صح." },
  hero_subtitle: { value_en: "Supplements and training essentials in one place.", value_ar: "مكملاتك وأساسياتك الرياضية في مكان واحد." },
  hero_cta: { value_en: "Shop now", value_ar: "تسوق دلوقتي" },
  hero_background_image: { value_en: "/keepfit-logo.png", value_ar: "" },
  ...
  order_bump_desc: { value_en: "A complementary product available with your order", value_ar: "اختيار إضافي متاح مع طلبك" },
...
const SECTIONS: SectionDef[] = [
  ...
  },
  {
    ...
    keys: [
      ...
      { key: "stat_carwashes", label: { en: "Partner Account Count", ar: "عدد الحسابات التجارية" }, type: "number" },
